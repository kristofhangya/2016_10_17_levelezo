...
uint16_t PWM_duty1   =  1250;
uint16_t PWM_duty2   =  2498;
uint8_t  PWM_state0   =  0;
uint8_t  PWM_state1   =  0;
uint8_t  PWM_state2   =  0;
...
ISR(TIMER0_OVF_vect)
{
    ...
    if(PWM_state0 == 0){PWM_duty0+=1;}
    else{PWM_duty0-=1;}
    if(PWM_state1 == 0){PWM_duty1+=1;}
    else{PWM_duty1-=1;}
    if(PWM_state2 == 0){ PWM_duty2+=1;}
    else{PWM_duty2-=1;
    }
    if(PWM_duty0 >= 2489) PWM_state0 = 1;
    if(PWM_duty1 >= 2489) PWM_state1 = 1;
    if(PWM_duty2 >= 2489) PWM_state2 = 1;
    if(PWM_duty0 <= 10)    PWM_state0 = 0;
    if(PWM_duty1 <= 10)    PWM_state1 = 0;
    if(PWM_duty2 <= 10)    PWM_state2 = 0;
}
